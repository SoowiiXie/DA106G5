...
<%@ page import="com.grp_detail.model.*"%>

<%
	Group_rptVO empVO = (Group_rptVO) request.getAttribute("empVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
