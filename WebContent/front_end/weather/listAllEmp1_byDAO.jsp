...
<%@page import="com.weather_detail.model.Weather_detailDAO"%>
...
<%
    ...
    List<Weather_detailVO> list = dao.getAll();
...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="select_page.jsp"><img src="images/LogoNoBack.png" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
