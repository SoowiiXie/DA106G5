...
<div id="contentMiddle" class="col-12 d-block" style="hight:100%;">
	...
	<div class="btn-group-vertical col-1">
		...
		<button type="button" class="btn btn-success wth_loc_btn" value="臺南市">臺南市</button>
	...
	<div class="btn-group-vertical col-1">
		...
		<button type="button" class="btn btn-danger wth_loc_btn" value="臺中市">臺中市</button>
	...
	<div class="btn-group-vertical col-1">
		...
		<button type="button" class="btn btn-warning wth_loc_btn" value="台北市">臺北市</button>
	</div>
	<div class="btn-group-vertical col-1">
