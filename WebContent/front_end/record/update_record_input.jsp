...
<%
  RecordVO recordVO = (RecordVO) request.getAttribute("recordVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<%= recordVO==null	 %>--${recordVO.rcd_no }--
<html>
<head>
...
<table id="table-1">
	<tr><td>
		 <h3>員工資料修改 - update_record_input.jsp</h3>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=recordVO.getRcd_uploadtime()%>', // value:   new Date(),
