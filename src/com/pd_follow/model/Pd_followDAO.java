...
public class Pd_followDAO implements Pd_followDAO_interface {
	...
	public static void main(String[] args) {
		...
		Pd_followDAO dao = new Pd_followDAO();

		 //新增，會員新增一個商品收藏
//		Pd_followVO pd_followVO1 = new Pd_followVO();
//		pd_followVO1.setMb_id("vain123");
//		pd_followVO1.setPd_no("PDN00008");
...
//		 System.out.println("商品編號："+pd_followVO1.getPd_no());
		...
		pd_followVO2.setMb_id("soowii123");
...
//		// 查詢，查詢單一會員收藏
//		List<Pd_followVO> list = dao.searchMemberAllPdFollow("vain123");
