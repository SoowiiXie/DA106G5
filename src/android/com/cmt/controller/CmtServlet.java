...
System.out.println("input: " + jsonIn);
		...
		if("add".equals(action)) {
			...
			String cmt_content = jsonObject.get("cmt_content").getAsString();
			java.sql.Date cmt_time=new java.sql.Date(System.currentTimeMillis());
			...
			if(cmtVO != null) {
				writeText(res, res.SC_OK+"");
			}else {
				writeText(res, res.SC_NOT_FOUND+"失敗");
			}
		}
