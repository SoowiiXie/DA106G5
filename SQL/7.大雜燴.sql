...
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'soowii123','loc00001',TO_TIMESTAMP('2020-05-15 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-15 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-10 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 20:30','YYYY-MM-DD HH24:MI'),'luck ball go','gogogo',20,5,15,1,30);

Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'xuan123','loc00002',TO_TIMESTAMP('2020-05-16 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-16 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-11 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 20:30','YYYY-MM-DD HH24:MI'),'happy ball go','gogogo',25,10,20,1,35);

Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'michael123','loc00003',TO_TIMESTAMP('2020-05-17 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-17 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-12 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-15 20:30','YYYY-MM-DD HH24:MI'),'sad ball go','gogogo',30,15,20,1,37);

Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'vain123','loc00004',TO_TIMESTAMP('2020-05-18 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-18 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-16 20:30','YYYY-MM-DD HH24:MI'),'laugh ball go','gogogo',35,20,20,1,38);
...
Insert into PATH (PATH_NO,PATH_NAME,PATH_DIFFICULTY,PATH_POPULAR,PATH_START,PATH_END,PATH_DISTANCE,PATH_STATUS,PATH_KML,PATH_LNG,PATH_LAT) values ('p'||LPAD(to_char(PATH_NO_SEQ.NEXTVAL), 5, '0'),'path5','3',2,to_timestamp('2020-03-20 18:18:18', 'YYYY-MM-DD HH24:MI:SS'),to_timestamp('2020-03-20 18:56:12', 'YYYY-MM-DD HH24:MI:SS'),464.21,1,'[{"LNG":"121.236168","LAT":"24.985739"},{"LNG":"121.236170","LAT":"24.985740"},{"LNG":"121.236175","LAT":"24.985745"},{"LNG":"121.236180","LAT":"24.985750"},{"LNG":"121.236185","LAT":"24.985755"},{"LNG":"121.236190","LAT":"24.985760"},{"LNG":"121.236195","LAT":"24.985765"},{"LNG":"121.236200","LAT":"24.985780"}]',121.236168,24.985739);
