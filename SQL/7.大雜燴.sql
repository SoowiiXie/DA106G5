...
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'yiwen123','loc00001',TO_TIMESTAMP('2020-05-14 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-16 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-16 20:30','YYYY-MM-DD HH24:MI'),'網球打到熱衰竭','大家好，我是阿文，有人要一起用生命打網球嗎，一起熱血打到不行吧!',8,1,1,1,0);

 
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'vain123','loc00002',TO_TIMESTAMP('2020-05-14 10:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 22:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 13:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-16 17:30','YYYY-MM-DD HH24:MI'),'天氣好熱、玩水開心','天氣這麼熱就是要出來游泳消暑吧 游完再一起去鉅大吃刨冰 限女性',20,1,1,1,0);


Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'xuan123','loc00003',TO_TIMESTAMP('2020-05-14 10:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 22:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 23:30','YYYY-MM-DD HH24:MI'),'元大鷹出來打球','吾乃中大東方翔，絕招是三分線後仰拉桿轉身跳投，希望有人來電電我',11,1,1,1,1);

Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'soowii123','loc00004',TO_TIMESTAMP('2020-05-14 10:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 22:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 08:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-15 21:30','YYYY-MM-DD HH24:MI'),'馬來西亞的鄉聚羽球','我是從馬來西亞來讀書的學生，希望有喜歡一起打羽球的人~',50,1,1,1,0);


Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'weijhih123','loc00005',TO_TIMESTAMP('2020-05-13 10:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-19 22:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-20 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-21 00:30','YYYY-MM-DD HH24:MI'),'羅主任上課囉','本人是專業健身教練，利用下班時間免費教導大家的運動姿勢，一起多人運動~',6,1,6,1,1);
...
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'androidlababy520','loc00001',TO_TIMESTAMP('2020-05-12 09:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 17:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 09:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 21:30','YYYY-MM-DD HH24:MI'),'大家一起快樂打網球','打網球是要快樂打，阿文瘋子有天只會把自己打死',10,1,1,1,0);
...
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'androidlababy520','loc00007',TO_TIMESTAMP('2020-05-13 05:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 17:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 05:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-15 21:30','YYYY-MM-DD HH24:MI'),'中央大學操場1000','才跑100圈太肉腳了，要跑就要用生命去跑',10,1,1,1,0);
