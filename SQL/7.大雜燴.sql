...
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'weijhih123','loc00005',TO_TIMESTAMP('2020-05-13 10:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-19 22:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-20 18:30','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-21 00:30','YYYY-MM-DD HH24:MI'),'羅主任上課囉','本人是專業健身教練，利用下班時間免費教導大家的運動姿勢，一起多人運動~',6,1,6,1,6);
