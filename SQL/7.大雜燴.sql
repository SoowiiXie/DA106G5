...
values('MSN'||LPAD(to_char(ntf_no_seq.NEXTVAL), 5, '0'),'soowii123','xuan123','哈囉你好啊');
Insert into MESSAGE( MSG_NO, MB_ID_1, MB_ID_2, MSG_CONTENT) 
values('MSN'||LPAD(to_char(ntf_no_seq.NEXTVAL), 5, '0'),'xuan123','soowii123','嗨嗨你好');
Insert into MESSAGE( MSG_NO, MB_ID_1, MB_ID_2, MSG_CONTENT) 
values('MSN'||LPAD(to_char(ntf_no_seq.NEXTVAL), 5, '0'),'michael123','vain123','我是麥可');
Insert into MESSAGE( MSG_NO, MB_ID_1, MB_ID_2, MSG_CONTENT) 
values('MSN'||LPAD(to_char(ntf_no_seq.NEXTVAL), 5, '0'),'vain123','michael123','我是Vain');
Insert into MESSAGE( MSG_NO, MB_ID_1, MB_ID_2, MSG_CONTENT) 
values('MSN'||LPAD(to_char(ntf_no_seq.NEXTVAL), 5, '0'),'vain123','michael123','哩賀');
...
CREATE TABLE weather_detail (
 ...
 weather_place VARCHAR2(10) NOT NULL,
 wth_status VARCHAR2(30) NOT NULL,
 wth_high NUMBER(3),
 wth_low NUMBER(3),
