...
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'androidlababy520','loc00001',TO_TIMESTAMP('2020-05-12 09:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-13 17:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 06:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-15 20:00','YYYY-MM-DD HH24:MI'),'大家一起快樂打網球','打網球是要快樂打，阿文瘋子有天只會把自己打死',10,1,1,1,0);
...
Insert into GROUPER(GRP_NO,MB_ID,LOC_NO,GRP_APPLYSTART,GRP_APPLYEND,GRP_START,GRP_END,GRP_NAME,GRP_CONTENT,GRP_PERSONMAX,GRP_PERSONMIN,GRP_PERSONCOUNT,GRP_STATUS,GRP_FOLLOW)
values('grp'||LPAD(to_char(grp_no_seq.NEXTVAL), 5, '0'),'androidlababy520','loc00007',TO_TIMESTAMP('2020-05-13 05:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-14 17:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-30 05:00','YYYY-MM-DD HH24:MI'),TO_TIMESTAMP('2020-05-31 21:30','YYYY-MM-DD HH24:MI'),'中央大學操場1000圈','才跑100圈太肉腳了，要跑就要用生命去跑',10,1,1,1,0);
